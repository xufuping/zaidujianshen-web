...
$(function() {
   ...
   function product (proType, j) {
       ...
       $.ajax({
           ...
           error: function() {
               alert("CourseList-Server error. Please try again.");
           }
       });
...
$(function() {
  ...
  $.ajax({
       ...
       error: function() {
           alert("About us words-Server error. Please try again.");
       }
  });
   ...
   $.ajax({
       ...
       error: function() {
           alert("About us banner-Server error. Please try again.");
       }
   });
...
$(function() {
   $(".writeSubmit").click(function(){
       ...
       if($("#writeName").val() == "" ||
           ...
           $("#writeTitle").val() == "" ||
           $("#writeText").val() == ""){
               alert("I'm sorry, the information you entered is incomplete.");
       } else {
           if(/^1[34578]\d{9}$/.test($("#writePhone").val())){
               ...
               alert("I'm sorry, your phone number is incorrect.");
           }
       }
   });
});